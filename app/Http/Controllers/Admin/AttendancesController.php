 ...
 */
	...
	public function show($id)
    {
        ...
        $this->data['employeeslist'] = Employee::pluck('fullName','employeeID');
	...
	public function update($date)
    {
        ...
        if($this->data['setting']->attendance_notification==1) {
            ...
            $employees = Employee::select('id','email','fullName')->where('status', '=', 'active')->get();
            foreach ($employees as $employee) {
                $this->data['employee_name'] = $employee->fullName;
	            //  Send Email to All active users
                // TODO: Mail Implementation
//                echo 'hello';die;
                event(new AttendanceEvent($employee, $this->data['date']));
            }
        }
