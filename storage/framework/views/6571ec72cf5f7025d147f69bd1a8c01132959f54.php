	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="<?php echo e(isset($employeesOpen) ? $employeesOpen : ''); ?>">
					...
					<ul class="sub-menu">
						<li class="<?php echo e(isset($employeesActive) ? $employeesActive : ''); ?>">
							...
							<i class="fa fa-users"></i>
							<?php echo Lang::get('menu.employeeList'); ?></a>
						</li>

                        <li class="<?php echo e(isset($employees1Active) ? $employees1Active : ''); ?>">
                            <a href="<?php echo e(route('admin.retirable.index')); ?>">
                            <i class="fa fa-users"></i>
                            <?php echo Lang::get('menu.employeeList1'); ?></a>
                                    </li>

                    <li class="<?php echo e(isset($employees2Active) ? $employees2Active : ''); ?>">
                            <a href="<?php echo e(route('admin.vacant.index')); ?>">
                            <i class="fa fa-users"></i>
                            <?php echo Lang::get('menu.employeeList2'); ?></a>
                                    </li>

                    <li class="<?php echo e(isset($employees3Active) ? $employees3Active : ''); ?>">
                    <a href="<?php echo e(route('admin.publication.index')); ?>">
                            <i class="fa fa-users"></i>
                            <?php echo Lang::get('menu.employeeList3'); ?></a>
                                    </li>
              ...
              <li class="<?php echo e(isset($learningOpen) ? $learningOpen : ''); ?>">
					<a href="javascript:;">
					<i class="fa fa-users"></i>
					<span class="title"><?php echo Lang::get('menu.learning'); ?></span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li class="<?php echo e(isset($learningActive) ? $learningActive : ''); ?>">
							<a href="<?php echo e(route('admin.competency.index')); ?>">
							<i class="fa fa-users"></i>
							<?php echo Lang::get('menu.learningList'); ?></a>
						</li>
              ...
              <li class="<?php echo e(isset($performanceOpen) ? $performanceOpen : ''); ?>">
					<a href="javascript:;">
					<i class="fa fa-users"></i>
					<span class="title"><?php echo Lang::get('menu.performance'); ?></span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li class="<?php echo e(isset($performanceActive) ? $performanceActive : ''); ?>">
