...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            <a href="javascript:;">
                <?php echo HTML::image("assets/admin/layout/img/{$setting->logo}",'Logo',array('class'=>'logo-default','height'=>'22px','width'=>'86px')); ?>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                					...
                					<ul class="dropdown-menu">
                						...
                						<li>
                							<ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                								...
                								<li>
                									<a  data-toggle="modal" href="#static_leave_requests" onclick="show_application_notification(<?php echo e($pending->id); ?>);return false;">
                									<span class="time"><?php echo e(date('d-M-Y',strtotime($pending->created_at))); ?></span>
                									<span class="details">
                									<span class="label label-sm label-icon label-success">
                									<i class="fa fa-bell-o"></i>
                									</span>
                									 <strong><?php echo e($pending->employeeDetails->fullName); ?> </strong> has applied for leave on <?php echo e(date('d-M-Y',strtotime($pending->date))); ?></span>
                									</a>
                								</li>
                ...
                <li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <?php echo HTML::image("assets/admin/layout/img/avatar3_small.jpg",'small image',array('class'=>'img-circle')); ?>
                  ...
                  <?php echo e($loggedAdmin->name); ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('screenlock')); ?> ">
