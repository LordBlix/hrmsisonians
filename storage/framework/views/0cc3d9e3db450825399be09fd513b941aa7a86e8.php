			...
			<!-- BEGIN PAGE CONTENT-->
                ...
                <i class="fa fa-plus"></i> </a>
                        				...
                        				<span id="load_notification"></span>
                        					 <input  type="checkbox"  onchange="ToggleEmailNotification('award_notification');return false;" class="make-switch" name="award_notification" <?php if($setting->award_notification==1): ?>checked	<?php endif; ?> data-on-color="success" data-on-text="Yes" data-off-text="No" data-off-color="danger">
...
<!-- END PAGE LEVEL PLUGINS -->
	...
	<script>
        	...
        	$('#awards').dataTable( {
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": "<?php echo e(route("admin.ajax_awards")); ?>",
                        "aaSorting": [[ 1, "asc" ]],
                        "aoColumns": [
