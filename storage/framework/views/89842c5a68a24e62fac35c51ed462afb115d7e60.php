...
<!-- BEGIN BODY -->
   ...
   <!-- BEGIN HEADER -->
            ...
            <!-- BEGIN PAGE CONTENT-->
            <h3 class="page-title">
			<?php echo e($pageTitle); ?> <small><?php echo Lang::get('menu.learningList'); ?></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo e(route('admin.competency.index')); ?>"><?php echo Lang::get('menu.learningList'); ?></a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
     ...
     <div class="row">
            <div class="col-md-18">
            <?php echo $__env->make('admin.include.sidebars', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          
                     <div class="tab-content">
                        <div class="<?php echo e(isset($tab1) ? $tab1 : 'tab-pane'); ?>" id="tab_1">
                        <?php echo Form::open(array('route'=>"admin.competency.store",'class'=>'form-horizontal','method'=>'POST','files' => true)); ?>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="employeeID" placeholder="Employee Name"
                                           value="<?php echo Session::get('errorr') or ''; ?>">
                                </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="employeeID" placeholder="Employee Name"
                                           value="<?php echo e(isset($errorr) ? $errorr : ''); ?>">
                                </div>
                                    </div>
                                    <div class="clearfix">
 ...
 <div class="form-actions text-center">
     <button type="submit" data-loading-text="Submitting..."
         ...
         <i class="fa fa-plus"></i> Submit
                        ...
                        <div class="<?php echo e(isset($tab7) ? $tab7 : 'tab-pane'); ?>" id="tab_7">
                        <?php echo Form::open(array('route'=>"admin.competency.store",'class'=>'form-horizontal','method'=>'POST','files' => true)); ?>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
   ...
   <!-- BEGIN CORE PLUGINS -->
   <?php echo HTML::script("css/metro/js/jquery-1.js"); ?>
