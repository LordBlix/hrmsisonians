         ...
         <div class="container-fluid">
            ...
            <ul class="nav pull-right">
               ...
               <li class="dropdown user">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  {!! HTML::image("css/metro/pic/avatar1_small.jpg") !!}
         ...
         <!-- BEGIN SIDEBAR MENU -->        	<ul>
        		...
        		<li class="">
					...
					<span class="title">Layouts</span>				
						...
						<li><a href="">Horzontal Menu 1</a>
						</li>
						<li><a href="">Horzontal Menu 2</a>
						</li>
						<li>
							<a href="">Promo Page</a>
						</li>
						...
						</li><a href="#">Content Loading via Ajax</a>
						</li>
						<li>
        		...
        		<li class="active ">
                  ...
                  <a href="#">Multiple File Upload</a>
						...
						<li><a href="#">Dropzone File Upload</a>
						</li>
							</ul>
								</li> 	        		
        		<li class="">
        			<a href="javascript:;">
					<i class="fa fa-icon-briefcase"></i> 
					<span class="title">Pages</span>
										<span class="fa fa arrow right"></span>
										</a>
									<ul class="sub-menu">
								<li>
							<a href="#"><i class="icon-cogs"></i>Coming Soon</a>
						</li>
							<li>
							<a href="#"><i class="icon-comments"></i>Blog</a>
						</li>
                  <li>
							<a href="#"><i class="icon-coffee"></i>News</a>
						</li>
						<li>
							<a href="#"><i class="icon-group"></i>About Us</a>
						</li><li>
							<a href="#"><i class="icon-envelope-alt"></i>Contact Us							</a>
						</li>
						<li>
        		...
        		<li class="">
					...
					<span class="title">Portlets</span>
									...
									<ul class="sub-menu">
					<li><a href="">General Portlets</a>
						</li>
                  <li><a href="">Draggable Portlets</a>
						</li>
										</ul>
								</li>		
        		<li class="">
