...
@section('mainarea')
    ...
    @else
        ...
        {!! Form::open(array('route'=>"admin.retirable.store",'class'=>'form-horizontal','method'=>'POST','files' => true)) !!}
        <div class="row ">
            <div class="col-md-12 col-sm-12">
                <div class="portlet box purple-wisteria">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-calendar"></i>Retirable List
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">No. of Retirable Employee :<span class="required">* </span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="nameOfRetirableName" placeholder="Retirable Employee Name"
